...
author: LYleonard
refrence: http://www.liaoxuefeng.com/
"""
...
class Dict(dict):
	...
	def __getattr__(self, key):
		try:
			...
			raise AttributeError(r"'Dict' onject has no attribute '%s'" % key)
...
def create_engine(user, password, database, host='127.0.0.1', port=3306, **kw):
	...
	defaults = dict(use_unicode=True, charset='utf8_general_ci', autocommit=False)
