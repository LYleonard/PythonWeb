...
def internalerror():
    '''send an interanl error response'''
...
class Request(object):
    ...
    def host(self):
        '''
        Get request host as str. Default to '' if caanot get host.
...
class Response(object):
    ...
    def content_type(self, value):
        '''
        Set cintent type for response. This is a shortcut for set_header('Content-Type', value).
        :param value:
        :return:
        '''
        if value:
    ...
    def delete_cookie(self, name):
        '''
        Delete a cookie immediately, name is the cookie name.
        :param name:
        :return:
        '''
...
class Jinja2TemplateEngine(TemplateEngine):
    ''' Render useing jinja2 template engine'''
